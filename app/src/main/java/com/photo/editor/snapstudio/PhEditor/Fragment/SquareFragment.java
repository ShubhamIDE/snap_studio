...
import com.photo.editor.snapstudio.PhEditor.Adapter.SquareAdapter;
...
import com.photo.editor.snapstudio.PhEditor.square.SquareView;
import com.photo.editor.snapstudio.PhEditor.sticker.SplashSticker;
...
public class SquareFragment extends DialogFragment implements SquareAdapter.SplashChangeListener {
    ...
    TextView textViewValue, blur_txt;
...
//                adsManager.showInterstitialAd();
    ...
    private void changeTheme() {
        ...
        if (isDarkTheme){
            ...
            blur_txt.setTextColor(getResources().getColor(R.color.white));
            ...
            blur_txt.setTextColor(getResources().getColor(R.color.blacktwo));
