...
import com.photo.editor.snapstudio.PhEditor.Adapter.FontAdapter;
import com.photo.editor.snapstudio.PhEditor.Adapter.ShadowAdapter;
import com.photo.editor.snapstudio.PhEditor.Adapter.TextBackgroundAdapter;
import com.photo.editor.snapstudio.PhEditor.Adapter.TextColorAdapter;
import com.photo.editor.snapstudio.PhEditor.Editor.EditText;
import com.photo.editor.snapstudio.PhEditor.Editor.Text;
import com.photo.editor.snapstudio.R;
import com.photo.editor.snapstudio.PhEditor.assets.FontFileAsset;
...
public class TextFragment extends DialogFragment implements View.OnClickListener, FontAdapter.ItemClickListener,
        ShadowAdapter.ShadowItemClickListener, TextColorAdapter.ColorListener, TextBackgroundAdapter.blacktwoListener {
        ...
        this.seekbar_background_opacity.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                ...
                TextFragment.this.polishText.setBackgroundAlpha(255 - i);
                    int red = Color.red(TextFragment.this.polishText.getblacktwo());
                    int green = Color.green(TextFragment.this.polishText.getblacktwo());
                    int blue = Color.blue(TextFragment.this.polishText.getblacktwo());
        ...
        this.seekbar_radius.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                ...
                TextFragment.this.polishText.setBackgroundBorder(i);
                    ...
                    gradientDrawable.setColor(Color.argb(TextFragment.this.polishText.getBackgroundAlpha(), Color.red(TextFragment.this.polishText.getblacktwo()), Color.green(TextFragment.this.polishText.getblacktwo()), Color.blue(TextFragment.this.polishText.getblacktwo())));
                    TextFragment.this.text_view_preview_effect.setBackground(gradientDrawable);
    ...
    public void initPreviewText() {
        if (this.polishText.isShowBackground()) {
            if (this.polishText.getblacktwo() != 0) {
                this.text_view_preview_effect.setBackgroundColor(this.polishText.getblacktwo());
            }
            if (this.polishText.getBackgroundAlpha() < 255) {
                this.text_view_preview_effect.setBackgroundColor(Color.argb(this.polishText.getBackgroundAlpha(), Color.red(this.polishText.getblacktwo()), Color.green(this.polishText.getblacktwo()), Color.blue(this.polishText.getblacktwo())));
            }
            if (this.polishText.getBackgroundBorder() > 0) {
                ...
                gradientDrawable.setColor(Color.argb(this.polishText.getBackgroundAlpha(), Color.red(this.polishText.getblacktwo()), Color.green(this.polishText.getblacktwo()), Color.blue(this.polishText.getblacktwo())));
    ...
    @Override
    public void onblacktwoSelected(int item, TextBackgroundAdapter.SquareView squareView) {
        if (squareView.isColor) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.image_view_adjust:
                ...
                image_view_adjust.setColorFilter(getResources().getColor(R.color.pink));
            ...
            case R.id.image_view_color:
                ...
                image_view_color.setColorFilter(getResources().getColor(R.color.pink));
            ...
            case R.id.image_view_keyboard:
                ...
                image_view_adjust.setBackgroundResource(R.drawable.background_unslelected);
                image_view_color.setBackgroundResource(R.drawable.background_unslelected);
                image_view_keyboard.setColorFilter(getResources().getColor(R.color.pink));
                image_view_adjust.setColorFilter(getResources().getColor(R.color.white));
                image_view_color.setColorFilter(getResources().getColor(R.color.white));
