package com.photo.editor.snapstudio.PhEditor.draw;
...
import com.photo.editor.snapstudio.PhEditor.listener.BrushColorChangeListener;
...
public class BrushDrawingView extends View {
    ...
    public void setPaintOpacity(@IntRange(from = 0, to = 255) int i) {
        this.paintOpacity = i;
        setBrushDrawingMode(true);
    }

    public void setNeonOpacity(@IntRange(from = 0, to = 255) int i) {
        this.neonOpacity = i;
        setBrushDrawingMode(true);
    }

    public void setMagicOpacity(@IntRange(from = 0, to = 255) int i) {
        this.magicOpacity = i;
        setBrushDrawingMode(true);
    }
