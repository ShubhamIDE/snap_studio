...
import com.photo.editor.snapstudio.AdsUtils.Utils.ConnectionDetector;
...
public class AdUtils {
    ...
    public static void showRewardAd(Activity activity, AppInterfaces.InterstitialADInterface adInterface) {
        ...
        if (cd.isConnectingToInternet()) {
            ...
            RewardedAd.load(activity, Constants.adsJsonPOJO.getParameters().getRewarded_ad().getDefaultValue().getValue(), adRequest, new RewardedAdLoadCallback() {
                @Override
                public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                    Global.sout("RewardedAdLoadCallback: ", loadAdError.toString());
                    adInterface.adLoadState(false);
                }
    ...
    public static void showNativeAd(Activity activity, LinearLayout adContainer, boolean isFullScreenAd, boolean isDarkTheme, boolean isExitDialog) {
        AppPreferences appPreferencesManger = new AppPreferences(activity);
        Constants.adsJsonPOJO = new Gson().fromJson(appPreferencesManger.getAdsModel(), AdsJsonPOJO.class);
        cd = new ConnectionDetector(activity);
        if (cd.isConnectingToInternet() && Constants.adsJsonPOJO.getParameters().getShowAd().getDefaultValue().getValue().equals("true") && Constants.NativeAdsList.size() > 0) {
            ...
            try {
                ...
                populateUnifiedNativeAdView(nativeAd, unifiedNativeAdView, isFullScreenAd, isDarkTheme);
...
//            }
    ...
    private static void populateUnifiedNativeAdView(NativeAd unifiedNativeAd, NativeAdView unifiedNativeAdView, boolean flag, boolean themeDark) {
        if (flag) {
            unifiedNativeAdView.setMediaView((MediaView) unifiedNativeAdView.findViewById(R.id.ad_media));
        }
        LinearLayout ad_main = unifiedNativeAdView.findViewById(R.id.ad_main);
        TextView ad_txt = unifiedNativeAdView.findViewById(R.id.ad_txt);
        ...
        if (themeDark) {
            ad_main.setBackgroundResource(R.color.blacktwo);
            ad_txt.setTextColor(Color.parseColor("#FFFFFF"));
            ...
            if (unifiedNativeAd.getCallToAction() == null) {
                ...
                /*((TextView) unifiedNativeAdView.getCallToActionView()).setTextColor(Color.parseColor("#10142B"));
                ((TextView) unifiedNativeAdView.getCallToActionView()).setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#FFFFFF")));*/
            }
            ...
            ad_txt.setTextColor(Color.parseColor("#10142B"));
            ad_main.setBackgroundResource(R.color.white);
            ((TextView) unifiedNativeAdView.getHeadlineView()).setText(unifiedNativeAd.getHeadline());
            ((TextView) unifiedNativeAdView.getHeadlineView()).setTextColor(Color.parseColor("#10142B"));
            if (unifiedNativeAd.getBody() == null) {
                unifiedNativeAdView.getBodyView().setVisibility(View.INVISIBLE);
            } else {
                unifiedNativeAdView.getBodyView().setVisibility(View.VISIBLE);
                ((TextView) unifiedNativeAdView.getBodyView()).setText(unifiedNativeAd.getBody());
                ((TextView) unifiedNativeAdView.getBodyView()).setTextColor(Color.parseColor("#10142B"));
            }
            if (unifiedNativeAd.getCallToAction() == null) {
                unifiedNativeAdView.getCallToActionView().setVisibility(View.INVISIBLE);
            } else {
                unifiedNativeAdView.getCallToActionView().setVisibility(View.VISIBLE);
                ((TextView) unifiedNativeAdView.getCallToActionView()).setText(unifiedNativeAd.getCallToAction());
                /*((TextView) unifiedNativeAdView.getCallToActionView()).setTextColor(Color.parseColor("#FFFFFF"));
                ((TextView) unifiedNativeAdView.getCallToActionView()).setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#10142B")));*/
            ...
            if (unifiedNativeAd.getPrice() == null) {
                ...
                ((TextView) unifiedNativeAdView.getPriceView()).setText(unifiedNativeAd.getPrice());
                ((TextView) unifiedNativeAdView.getPriceView()).setTextColor(Color.parseColor("#10142B"));
            }
            if (unifiedNativeAd.getStore() == null) {
                unifiedNativeAdView.getStoreView().setVisibility(View.INVISIBLE);
            } else {
                ...
                ((TextView) unifiedNativeAdView.getStoreView()).setText(unifiedNativeAd.getStore());
                ((TextView) unifiedNativeAdView.getStoreView()).setTextColor(Color.parseColor("#10142B"));
            }
            if (unifiedNativeAd.getStarRating() == null) {
                unifiedNativeAdView.getStarRatingView().setVisibility(View.INVISIBLE);
            } else {
            ...
            if (unifiedNativeAd.getAdvertiser() == null) {
                ...
                ((TextView) unifiedNativeAdView.getAdvertiserView()).setText(unifiedNativeAd.getAdvertiser());
                ((TextView) unifiedNativeAdView.getAdvertiserView()).setTextColor(Color.parseColor("#10142B"));
                unifiedNativeAdView.getAdvertiserView().setVisibility(View.VISIBLE);
            }
        }
    ...
    public static void loadInitialRewardedAds(Context context) {
        try {
            AppPreferences manager = new AppPreferences(context);
            Constants.adsJsonPOJO = Global.getAdsData(manager.getAdsModel());
            ...
            int i = 0;
            while (i < 3) {
                Global.sout("Rewarded ads list size before >>>>", Constants.RewardedAdsList.size());
                if (Constants.RewardedAdsList.size() <= 4 && Constants.adsJsonPOJO != null) {
                    AdRequest adRequest = new AdRequest.Builder().build();
                    RewardedAd.load(context, Constants.adsJsonPOJO.getParameters().getRewarded_ad().getDefaultValue().getValue(), adRequest, new RewardedAdLoadCallback() {
                        @Override
                        public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
...
//                            super.onAdLoaded(rewardedAd);
                            Constants.RewardedAdsList.add(rewardedAd);
                            Global.sout("Rewarded ads list size after >>>>", Constants.RewardedAdsList.size());
                        }
                    });
            } else{
                break;
    ...
    {
        Global.sout("Rewarded list exception", e.getLocalizedMessage());
    }
