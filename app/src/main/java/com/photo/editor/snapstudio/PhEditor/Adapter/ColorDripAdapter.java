...
public class ColorDripAdapter extends RecyclerView.Adapter<ColorDripAdapter.ViewHolder> {
    ...
    public ColorDripAdapter(Context context2, blacktwoListener backgroundInstaListener2) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            ColorDripAdapter.this.backgroundInstaListener.onblacktwoSelected(ColorDripAdapter.this.selectedSquareIndex, ColorDripAdapter.this.squareViews.get(ColorDripAdapter.this.selectedSquareIndex));
