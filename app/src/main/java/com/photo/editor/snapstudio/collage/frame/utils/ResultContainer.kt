...
import com.photo.editor.snapstudio.collage.frame.FrameEntity
import com.photo.editor.snapstudio.collage.multitouch.MultiTouchEntity
...
class ResultContainer private constructor() {
    ...
    private val mDecodedImageMap = HashMap<String, Bitmap>()
