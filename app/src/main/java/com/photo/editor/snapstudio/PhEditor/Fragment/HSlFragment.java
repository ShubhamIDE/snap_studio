...
public class HSlFragment extends DialogFragment {
   ...
   ConstraintLayout mainLayout;
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.close = inflate.findViewById(R.id.imageViewCloseRatio);
        this.save = inflate.findViewById(R.id.imageViewSaveRatio);
...
//                    tempbitmap2.recycle();
    ...
    private void changeTheme() {
        ...
        if (isDarkTheme){
            ...
            h.setTextColor(getResources().getColor(R.color.blacktwo));
            s.setTextColor(getResources().getColor(R.color.blacktwo));
            l.setTextColor(getResources().getColor(R.color.blacktwo));
        }
    }
