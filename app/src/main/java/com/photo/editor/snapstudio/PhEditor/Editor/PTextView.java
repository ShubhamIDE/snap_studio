    ...
    public void draw(@NonNull Canvas paramCanvas) {
        ...
        if (this.isShowBackground) {
            ...
            if (this.backgroundDrawable != null) {
                ...
                paint.setARGB(this.backgroundAlpha, Color.red(this.blacktwo), Color.green(this.blacktwo), Color.blue(this.blacktwo));
            }
