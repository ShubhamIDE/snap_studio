...
import com.photo.editor.snapstudio.PhEditor.support.SupportedClass;
import com.photo.editor.snapstudio.PhEditor.utils.MotionUtils;

//import com.coding.photo.edit.constants.StoreManager;
//import com.coding.photo.edit.support.SupportedClass;
//import com.coding.photo.edit.utils.MotionUtils;


public class
CropAsyncTask extends AsyncTask<Void, Void, Void> {
    Activity activity;
