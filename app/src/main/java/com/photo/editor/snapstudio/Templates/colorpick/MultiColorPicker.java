package com.photo.editor.snapstudio.Templates.colorpick;
...
public class MultiColorPicker extends View {
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        state.putFloatArray("build/intermediates/exploded-aar/com.android.support/appcompat-v7/23.1.1/res/color", colorHSV);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            colorHSV = bundle.getFloatArray("build/intermediates/exploded-aar/com.android.support/appcompat-v7/23.1.1/res/color");
            updateAdjacentHue();
