...
import com.photo.editor.snapstudio.PhEditor.eraser.ConstantsApp;
import com.photo.editor.snapstudio.PhEditor.eraser.ImageUtils;
import com.photo.editor.snapstudio.PhEditor.eraser.eraser.EraseView;
import com.photo.editor.snapstudio.PhEditor.eraser.eraser.MultiTouchListener;
...
public class EraseActivity extends BaseActivity implements OnClickListener {
    ...
    public int width;
    ImageView redo_btn, imageViewAuto, ivExtract, ivEraser, ivBg, ivRestore, ivZoom;
    TextView textViewAuto, tvExtract, tvEraser, tvBg, tvRestore, tvZoom;
    ...
    ConstraintLayout constraint_layout_confirm;
    TextView tv_offs, tv_offse, tv_threshold, tv_offset, tv_size;
    ...
    public void onCreate(Bundle bundle) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new MyExceptionHandlerPix(EraseActivity.this));
        ...
        this.main_rel.postDelayed(new Runnable() {
            public void run() {
                if (isTutOpen) {
                    imageViewBackgroundCover.setImageBitmap(ImageUtils.getTiledBitmap(EraseActivity.this, R.drawable.tbg3, width, height));
                    bgCircleBit = ImageUtils.getBgCircleBit(EraseActivity.this, R.drawable.tbg3);
                } else {
                    imageViewBackgroundCover.setImageBitmap(ImageUtils.getTiledBitmap(EraseActivity.this, R.drawable.tbg, width, height));
    ...
    private void initUI() {
        this.tv_offs = findViewById(R.id.tv_offs);
        this.tv_offse = findViewById(R.id.tv_offse);
        this.tv_size = findViewById(R.id.tv_size);
        this.tv_offset = findViewById(R.id.tv_offset);
        this.tv_threshold = findViewById(R.id.tv_threshold);

        this.imageViewAuto = findViewById(R.id.imageViewAuto);
        this.textViewAuto = findViewById(R.id.textViewAuto);
        this.ivExtract = findViewById(R.id.imageViewExtract);
        this.tvExtract = findViewById(R.id.textViewExtract);
        this.ivEraser = findViewById(R.id.imageViewEraser);
        this.tvEraser = findViewById(R.id.tvEraser);
        this.ivBg = findViewById(R.id.imageViewBackground);
        this.tvBg = findViewById(R.id.tvBg);
        this.ivRestore = findViewById(R.id.imageViewRestore);
        this.tvRestore = findViewById(R.id.tvRestore);
        this.ivZoom = findViewById(R.id.imageViewZoom);
        this.tvZoom = findViewById(R.id.tvZoom);

        this.mainLayout = findViewById(R.id.activity_main);
        this.constraint_layout_confirm = findViewById(R.id.constraint_layout_confirm);
    ...
    private void changeTheme() {
        ...
        //  AdUtils.showNativeAd(EraseActivity.this, findViewById(R.id.native_ads), false, isDarkTheme);
        if (isDarkTheme) {
            mainLayout.setBackgroundResource(R.color.blacktwo);
            constraint_layout_confirm.setBackgroundResource(R.color.blacktwo);
            undo_btn.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.white)));
            redo_btn.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.white)));
            back_btn.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.white)));
            save_btn.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.white)));

            imageViewAuto.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.white)));
            ivEraser.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.white)));
            ivZoom.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.white)));
            ivRestore.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.white)));
            ivBg.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.white)));
            ivExtract.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.white)));
            textViewAuto.setTextColor(getResources().getColor(R.color.white));
            tvExtract.setTextColor(getResources().getColor(R.color.white));
            tvEraser.setTextColor(getResources().getColor(R.color.white));
            tvBg.setTextColor(getResources().getColor(R.color.white));
            tvRestore.setTextColor(getResources().getColor(R.color.white));
            tvZoom.setTextColor(getResources().getColor(R.color.white));

            tv_threshold.setTextColor(getResources().getColor(R.color.white));
            tv_offset.setTextColor(getResources().getColor(R.color.white));
            tv_offse.setTextColor(getResources().getColor(R.color.white));
            tv_offs.setTextColor(getResources().getColor(R.color.white));
            tv_size.setTextColor(getResources().getColor(R.color.white));

            textViewAutoOffset.setTextColor(getResources().getColor(R.color.white));
            textViewBrushOffset.setTextColor(getResources().getColor(R.color.white));
            textViewBrushSize.setTextColor(getResources().getColor(R.color.white));
            textViewExtractOffset.setTextColor(getResources().getColor(R.color.white));

        } else {
            mainLayout.setBackgroundResource(R.color.white);
            constraint_layout_confirm.setBackgroundResource(R.color.white);
            undo_btn.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.blacktwo)));
            redo_btn.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.blacktwo)));
            back_btn.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.blacktwo)));
            save_btn.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.blacktwo)));

            imageViewAuto.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.blacktwo)));
            ivEraser.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.blacktwo)));
            ivZoom.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.blacktwo)));
            ivRestore.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.blacktwo)));
            ivBg.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.blacktwo)));
            ivExtract.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.blacktwo)));
            textViewAuto.setTextColor(getResources().getColor(R.color.blacktwo));
            tvExtract.setTextColor(getResources().getColor(R.color.blacktwo));
            tvEraser.setTextColor(getResources().getColor(R.color.blacktwo));
            tvBg.setTextColor(getResources().getColor(R.color.blacktwo));
            tvRestore.setTextColor(getResources().getColor(R.color.blacktwo));
            tvZoom.setTextColor(getResources().getColor(R.color.blacktwo));

            tv_threshold.setTextColor(getResources().getColor(R.color.blacktwo));
            tv_offset.setTextColor(getResources().getColor(R.color.blacktwo));
            tv_offse.setTextColor(getResources().getColor(R.color.blacktwo));
            tv_offs.setTextColor(getResources().getColor(R.color.blacktwo));
            tv_size.setTextColor(getResources().getColor(R.color.blacktwo));

            textViewAutoOffset.setTextColor(getResources().getColor(R.color.blacktwo));
            textViewBrushOffset.setTextColor(getResources().getColor(R.color.blacktwo));
            textViewBrushSize.setTextColor(getResources().getColor(R.color.blacktwo));
            textViewExtractOffset.setTextColor(getResources().getColor(R.color.blacktwo));
        }
    }
                    ...
                    if (bitmap != null) {
                        try {
                            ...
                            if (openFrom.equalsIgnoreCase(Constants.VALUE_OPEN_FROM_NEON)) {
                                NeonActivity.resultBitmap = bitmap;
                                ...
                                WingActivity.resultBmp = bitmap;
                            } else if (openFrom.equalsIgnoreCase(Constants.VALUE_OPEN_FROM_BG)) {
                                BgChangeActivity.eraserResultBmp = bitmap;
//                            } else if (openFrom.equalsIgnoreCase(Constants.VALUE_OPEN_FROM_S)) {
//                                SEditorActivity.eraserResultBitmap = bitmap;
                            }
                            setResult(RESULT_OK);
                            finish();
    ...
    public void setImageBitmap() {
        ...
        this.dv.setUndoRedoListener(new EraseView.UndoRedoListener() {
            public void enableUndo(boolean z, int i) {
                if (z) {
                    EraseActivity stickerRemoveActivity = EraseActivity.this;
                    stickerRemoveActivity.setBGDrawable(i, undo_btn, R.drawable.undo, z);
                    return;
                }
                EraseActivity stickerRemoveActivity2 = EraseActivity.this;
                stickerRemoveActivity2.setBGDrawable(i, undo_btn, R.drawable.undo, z);
            }

            public void enableRedo(boolean z, int i) {
                if (z) {
                    EraseActivity stickerRemoveActivity = EraseActivity.this;
                    stickerRemoveActivity.setBGDrawable(i, redo_btn, R.drawable.undo, z);
                    return;
                }
                EraseActivity stickerRemoveActivity2 = EraseActivity.this;
                stickerRemoveActivity2.setBGDrawable(i, redo_btn, R.drawable.undo, z);
            }
        });
        this.b.recycle();
