...
public class StickerFileAsset {
    ...
    public static List<String> chickenList() {
        List<String> arrayList = new ArrayList<>();
    ...
    public static List<String> cuteList() {
        List<String> arrayList = new ArrayList<>();
    ...
    public static List<String> heartList() {
        List<String> arrayList = new ArrayList<>();
    ...
    public static List<String> lovedayList() {
        List<String> arrayList = new ArrayList<>();
    ...
    public static List<String> sweetList() {
        List<String> arrayList = new ArrayList<>();
    ...
    public static List<String> textcolorList() {
        List<String> arrayList = new ArrayList<>();
    ...
    public static List<String> textneonList() {
        List<String> arrayList = new ArrayList<>();
