...
class GalleryAlbumRecyclerAdapter(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val isDarkTheme = mContext.getSharedPreferences(mContext.resources.getString(R.string.app_name), AppCompatActivity.MODE_PRIVATE).getBoolean("isDarkTheme", false)
        if (isDarkTheme) {
//            mainLayout?.setBackgroundColor(resources.getColor(R.color.blacktwo))
            ...
            holder.itemCountView.setTextColor((mContext.resources.getColor(R.color.white)))
        } else {
//            mainLayout?.setBackgroundColor(resources.getColor(R.color.white))
            holder.titleView.setTextColor((mContext.resources.getColor(R.color.blacktwo)))
            holder.itemCountView.setTextColor((mContext.resources.getColor(R.color.blacktwo)))
