...
import com.photo.editor.snapstudio.PhEditor.Adapter.BorderRatioAdapter;
import com.photo.editor.snapstudio.PhEditor.Adapter.ColorRatioAdapter;
import com.photo.editor.snapstudio.PhEditor.Adapter.GradientRatioAdapter;
...
public class RatioFragment extends DialogFragment implements AspectAdapter.OnNewSelectedListener,
        GradientRatioAdapter.BackgroundInstaListener, ColorRatioAdapter.blacktwoListener, BorderRatioAdapter.BackgroundBorderListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.save = inflate.findViewById(R.id.image_view_save);
        this.close = inflate.findViewById(R.id.image_view_close);
        this.textView = inflate.findViewById(R.id.title);
        this.textViewValue = inflate.findViewById(R.id.textViewValue);
        this.padding_txt = inflate.findViewById(R.id.padding_txt);
        ...
        this.imageViewCrop.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                imageViewCrop.setColorFilter(getResources().getColor(R.color.pink));
        ...
        this.imageViewGradient.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                imageViewGradient.setColorFilter(getResources().getColor(R.color.pink));
                imageViewBorder.setBackgroundResource(R.drawable.background_unslelected);
                imageViewBorder.setColorFilter(getResources().getColor(R.color.white));
                imageViewColor.setBackgroundResource(R.drawable.background_unslelected);
                imageViewColor.setColorFilter(getResources().getColor(R.color.white));
        ...
        this.imageViewBorder.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                imageViewBorder.setColorFilter(getResources().getColor(R.color.pink));
                imageViewColor.setBackgroundResource(R.drawable.background_unslelected);
                imageViewColor.setColorFilter(getResources().getColor(R.color.white));
            }
        });
    ...
    private void changeTheme() {
        ...
        if (isDarkTheme){
            ...
            padding_txt.setTextColor(getResources().getColor(R.color.white));
            ...
            padding_txt.setTextColor(getResources().getColor(R.color.blacktwo));
            textViewValue.setTextColor(getResources().getColor(R.color.blacktwo));
        }
    }
    ...
    @Override
    public void onblacktwoSelected(int item, ColorRatioAdapter.SquareView squareView) {
