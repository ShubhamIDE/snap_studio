...
public class DripColorAdapter extends RecyclerView.Adapter<DripColorAdapter.ViewHolder> {
    ...
    public DripColorAdapter(Context context, ColorListener frameListener) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            DripColorAdapter.this.selectedSquareIndex = getAdapterPosition();
            DripColorAdapter.this.colorListener.onColorSelected(DripColorAdapter.this.selectedSquareIndex, DripColorAdapter.this.squareViewList.get(DripColorAdapter.this.selectedSquareIndex));
            DripColorAdapter.this.notifyDataSetChanged();
        }
    }
