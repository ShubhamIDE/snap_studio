...
public class ColorRatioAdapter extends RecyclerView.Adapter<ColorRatioAdapter.ViewHolder> {
    public blacktwoListener backgroundInstaListener;
    ...
    public ColorRatioAdapter(Context context2, blacktwoListener backgroundInstaListener2) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            ColorRatioAdapter.this.backgroundInstaListener.onblacktwoSelected(ColorRatioAdapter.this.selectedSquareIndex, ColorRatioAdapter.this.squareViews.get(ColorRatioAdapter.this.selectedSquareIndex));
